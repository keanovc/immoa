                    ...
                    <div id="dropdown" class={`absolute w-44 px-5 py-3 backdrop-blur-md bg-white/30 bg-white rounded-lg shadow border dark:border-transparent top-20 z-10 ${toggle ? '' : 'hidden'}`}>
                        ...
                        <ul className="py-1 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="dropdownDefault">
                            <li class="font-medium mt-3">
                                <Link to={AdminRoutes.Index} class="flex items-center transform transition-colors duration-200 border-r-4 border-transparent hover:border-indigo-700">
                                    <div class="mr-3">
                                        <svg class="w- h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><MdSpaceDashboard className="text-2xl"/></svg>
                                    </div>
                                    Dashboard
                                </Link>
                            </li>
